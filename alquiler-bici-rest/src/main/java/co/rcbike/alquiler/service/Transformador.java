...
public class Transformador {
    ...
    // public static <A, B> List<B> crearListObjetosDestino(List<A>
    // listaObjetosOrigen, Class<B> claseDestino) {
    // List<B> result = null;
    // try {
    ...
    // }
    //
    // public static <A, B> Set<B> crearSetObjetosDestino(Set<A>
    // setObjetosOrigen, Class<B> claseDestino) {
    // Set<B> result = null;
    // try {
