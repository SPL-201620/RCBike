...
insert into Ruta (id,nombre,descripcion,emailCreador,tipo,latitudInicio,longitudInicio,latitudFinal,longitudFinal,distancia,tiempoEstimado,calorias,clima,fecha,frecuente) values(-1,'Ruta 1', 'Ruta 1','maria.a@email.com','INDIVIDUAL',4.614499,-74.091609,4.633060,-74.070538,100.0,29,33,'16ºC',{ts '2016-10-24 18:47:52.69'},'N');
insert into Ruta (id,nombre,descripcion,emailCreador,tipo,latitudInicio,longitudInicio,latitudFinal,longitudFinal,distancia,tiempoEstimado,calorias,clima,fecha,frecuente) values(-2,'Ruta 2', 'Ruta 2','alfon.cardozo@mensajeria.com','GRUPAL',4.603195,-74.065271,4.594787,-74.077964,100.0,29,33,'17ºC',{ts '2016-10-25 18:47:52.69'},'S');
