...
public class DesplazamientosService {
     ...
     * 
     * @param id
     *            Identificado de la participante
     */
    public ParticipanteJpa getParticipante(Long id) {
        TypedQuery<ParticipanteJpa> q = em.createNamedQuery(ParticipanteJpa.SQ_findByIdParticipante,
