...
public class MensajeriaManager implements Serializable {
	...
	public void listConversaciones() {
		List<String> emailReceptores = modulosManager.root(Modulo.mensajeria)
				.path(OperacionesMensajeria.EP_MENSAJERIA)
				.path(OperacionesMensajeria.OP_CONVERSACIONES)
				.path(AutenticacionManager.emailAutenticado()).request()
	...
	public void seleccionarConversacion(Usuario conversacionSeleccionada) {
		...
		mensajesConversacion = modulosManager.root(Modulo.mensajeria)
				.path(OperacionesMensajeria.EP_MENSAJERIA)
				.path(OperacionesMensajeria.OP_MENSAJE)
				.path(AutenticacionManager.emailAutenticado())
				.path(conversacionSeleccionada.getEmail()).request()
				.get(gTListMensaje);
	...
	public void onNuevaConversacionSelect(SelectEvent event) {
		...
		RequestContext.getCurrentInstance().execute(
				"marcarConvByIdClass('" + usuario.getId() + "');");
	}
